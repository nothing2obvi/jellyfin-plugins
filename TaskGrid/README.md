...
- Synced horizontal scrollbars above and below the grid
...
- Jellyfin 10.11: `task-grid-1.1.13.0.zip`
- Jellyfin v12-rc2: `task-grid-1.2.13.0-jellyfin12-rc2.zip`
- Jellyfin v12-rc3: `task-grid-1.3.13.0-jellyfin12-rc3.zip`
